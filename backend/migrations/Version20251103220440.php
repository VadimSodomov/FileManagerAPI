...
final class Version20251103220440 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE file (id BIGSERIAL NOT NULL, user_id BIGINT NOT NULL, folder_id BIGINT NOT NULL, name TEXT NOT NULL, server_name TEXT NOT NULL, cdate TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, mime_type TEXT NOT NULL, size BIGINT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE file ADD CONSTRAINT FK_8C9F3610162CB942 FOREIGN KEY (folder_id) REFERENCES folder (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
