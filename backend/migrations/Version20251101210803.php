...
final class Version20251101210803 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE folder (id SERIAL NOT NULL, user_id BIGINT NOT NULL, parent_id BIGINT DEFAULT NULL, name TEXT NOT NULL, cdate TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX IF NOT EXISTS idx_unique_folder_parent_name ON folder (parent_id, name)');
    }
